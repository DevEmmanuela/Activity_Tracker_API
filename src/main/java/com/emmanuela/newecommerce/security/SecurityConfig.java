...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/users/**", "/tasks/**",  "/**").permitAll();


        http.authorizeRequests().antMatchers(HttpMethod.GET, "/users/get-user/**",
                "/users/get-username", "/tasks/task-by-status", "/tasks/all-task").hasAnyAuthority("USER");
        ...
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/tasks/delete-task/{id}")
                        .hasAnyAuthority("USER");
